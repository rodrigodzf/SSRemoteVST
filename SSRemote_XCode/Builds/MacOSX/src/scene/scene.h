...
namespace SSR
{
    ...
    public:
        ...
        /**
         * Writes xml with source position and others
         *
         *
         *
         */
        ...
        /**
         * Sets the source radius based on the listener.
         *
         *
         ...
         *
         */
        void set_radius_discrete_of_selected_source(const float radius);
        
        /**
         * Sets the continuous radius based on the listener.
         *
         *
         * @param           radius          The new radius.
         *
         *
         */
        void set_radius_continuous_of_selected_source(const float radius);
        
        /**
         * Returns the radius.
         *
         * @return the radius of the current selected source.
         */
        SSR::Parameter<float, float> get_radius_of_selected_source() const;
        
        /**
         * Sets the discrete angle of the current selected source.
         *
         *
         * @param           angle           The new discrete angle the
         *                                  current selected source shall be
         *                                  set to.
         */
        void set_angle_discrete_of_selected_source(const float angle);
        
        /**
         * Sets the continuous Y position of the current selected source to
         * the transferred position.
         *
         * @param           angle           The new continuous angle the
         *                                  current selected source shall be
         *                                  set to.
         */
        void set_angle_continuous_of_selected_source(const float angle);
        
        /**
         * Returns the angle of the current selected source.
         *
         * @return the angle of the current selected source.
         */
        SSR::Parameter<float, float> get_angle_of_selected_source() const;
        ...
        /**
         * Returns the orientation of the reference.
         *
         * @return the orientation of the reference.
         */
        SSR::Parameter<float, float> get_reference_orientation() const;
    ...
    private:
         ...
         */
        Parameter<float, float> reference_orientation;
